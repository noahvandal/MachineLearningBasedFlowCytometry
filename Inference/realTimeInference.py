...
from classifierNets import ClassifierHyperparam_v3
...
if __name__ == '__main__':
    ...
    modelPath = '/home/noahvandal/my_project_dir/my_project_env/TrainUNET/Models/051523_2c_2e_1e-4lr_16bs_100ep_FineTune.pt'

    classifyModelPath = rootPath + 'HybridNet/Dataset/Model/051823_2c_Hyperparam_v3_fillTrain_noAug_drop10_bn_binaryBack_adamW_631split_earlyTerminate_calcweight_EntireDatset.pt'
    # videoPath = rootPath + 'DatasetFeb10/HPNE/230203121917.mp4'
    # videoPath = rootPath + \
    # 'Videos/August 2022/20um/5ul_min/25x mag/1280x960 px/5_25_1280_0.mp4'
    # magnification = 25
    name = '051823_2c_Hyperparam_v3_fillTrain_noAug_drop10_bn_binaryBack_adamW_631split_earlyTerminate_calcweight_EntireDatset'

    dateFolder = '18_May/'  ## the name of folder within output folder
